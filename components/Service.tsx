...
const Service = () => {
  ...
  return (
    <section className="py-10 flex justify-center items-center flex-col" id="service">
      <h3 className="p-10 m-5 text-4xl flex items-center justify-center gap-2 font-bold"> <span className="bg-purple-700 text-white p-2 rounded-sm">Our</span> Service</h3>
